"use strict";
$(function () {
   var e, t = $(".datatables-permissions"),
   ...
   t.length && (e = t.DataTable({
      ...
      columnDefs: [{
         ...
         orderable: !1,
         render: function (e, t, a, n) {
            for (var s = a.assigned_to, r = "", o = {
                  Admin: '<a href="' + l + '"><span class="badge rounded-pill bg-label-primary m-1">Administrator</span></a>',
                  Manager: '<a href="' + l + '"><span class="badge rounded-pill bg-label-warning m-1">Manager</span></a>',
                  Users: '<a href="' + l + '"><span class="badge rounded-pill bg-label-success m-1">Users</span></a>',
                  Support: '<a href="' + l + '"><span class="badge rounded-pill bg-label-info m-1">Support</span></a>',
                  Restricted: '<a href="' + l + '"><span class="badge rounded-pill bg-label-danger m-1">Restricted User</span></a>'
               }, d = 0; d < s.length; d++) r += o[s[d]];
